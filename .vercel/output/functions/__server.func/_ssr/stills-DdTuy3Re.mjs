...
import { p as cn } from "./router-p48W-Dqv.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/stills-DdTuy3Re.js
var import_jsx_runtime = require_jsx_runtime();
function Lights({ dots }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "still-lights",
		"aria-hidden": true,
		children: dots.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: {
			left: d.x,
			top: d.y,
			width: d.s,
			height: d.s,
			animationDelay: d.d ?? `${i * .35}s`
		} }, i))
	});
}
function TrainWindow() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "linear-gradient(180deg, #14161c 0%, #0c1018 42%, #1a1420 100%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lights, { dots: [
			{
				x: "18%",
				y: "38%",
				s: 3
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "still-rain" }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "absolute inset-x-[8%] top-[10%] bottom-[18%] rounded-sm",
			style: { boxShadow: "inset 0 0 0 10px #0a0a0c, inset 0 0 0 11px #2a2a2e" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute left-1/2 top-[10%] bottom-[18%] w-px bg-border" }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function RooftopDusk() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "linear-gradient(180deg, #1a1520 0%, #3a2430 38%, #c45c3e 62%, #e8b48a 78%, #0a0a0c 78%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function LanternAlley() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "linear-gradient(90deg, #08080c 0%, #161018 40%, #1c1410 70%, #0a0a0c 100%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function EmptyClassroom() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "linear-gradient(180deg, #2a241c 0%, #c4a078 55%, #eceae4 70%, #1a1814 70%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function HighWindow() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "linear-gradient(180deg, #1c1824 0%, #4a3040 45%, #d4785a 70%, #0a0a0c 70%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "absolute inset-x-[18%] top-[8%] bottom-[22%]",
			style: { boxShadow: "inset 0 0 0 14px #121214" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute left-1/2 top-[8%] bottom-[22%] w-2 bg-surface" }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-x-[18%] top-1/2 h-2 bg-surface" }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function NightOcean() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "linear-gradient(180deg, #0c1018 0%, #141c28 48%, #0a1218 48%, #080c12 100%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function StationClock() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "radial-gradient(ellipse at 50% 38%, #2a2420 0%, #0c0c10 62%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function RainCrossing() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "still-sky",
			style: { background: "linear-gradient(180deg, #161820 0%, #0c1016 55%, #12141a 100%)" }
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "still-rain" }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function CinematicStill({ id, className, ken, alt }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: cn("absolute inset-0", ken && "reel-ken"),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scene, {})
		})
	});
}
//#endregion
export { CinematicStill as t };
